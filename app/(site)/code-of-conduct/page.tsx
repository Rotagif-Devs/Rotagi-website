    ...
    <div className="min-h-screen bg-[#FCE7F3]">
      ...
      <section className="max-w-6xl mx-auto py-16 px-6">
        <div className="space-y-12">
          {/* Section 1 */}
          <div>
            <h2 className="text-3xl font-cal-sans font-medium text-gray-900 mb-6">
              1. Our Commitment
            </h2>
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>
                  International safeguarding and child protection standards
                </li>
              </ul>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="list-disc ml-6 space-y-2">
                <li>
                  All programme participants: She Ignite, She Blossom, She
                  Blaze, She Ascend
                </li>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-pink-100">
                ...
                <h4 className="text-gray-900 mb-2">Measurable Impact</h4>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-pink-100">
                ...
                <h4 className="text-gray-900 mb-2">Equitable Access</h4>
                <p className="text-gray-600 text-sm">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-pink-100">
                ...
                <h4 className="text-gray-900 mb-2">Responsible Innovation</h4>
                <p className="text-gray-600 text-sm">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-pink-100">
                ...
                <h4 className="text-gray-900 mb-2">Gender Leadership</h4>
                <p className="text-gray-600 text-sm">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>
                  Comply with all safeguarding and child protection
                  requirements.
                </li>
              </ul>
            </div>
          ...
          <div>
            ...
            <div className="space-y-8">
              <div>
                <h4 className="font-semibold text-[#D81B7E] mb-3">
              ...
              <div>
                ...
                <ul className="list-disc ml-6 space-y-2 text-gray-700">
                  <li>
                    Discrimination based on gender, age, religion, ethnicity,
              ...
              <div>
                ...
                <ul className="list-disc ml-6 space-y-2 text-gray-700">
                  <li>
                    Using AI or digital tools to harm, deceive, or manipulate.
                  </li>
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="font-medium text-red-600 mt-4 italic">
                Failure to comply with safeguarding standards may result in
                immediate removal and referral to relevant authorities.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>
                  Respect the confidentiality of discussions and materials.
                </li>
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>
                  Respect intellectual property when using AI generated outputs.
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-[#D81B7E] mt-4">
                ...
                <p>
                  Email:{" "}
                  <a
                    href="mailto:privacy@rotagif.com"
                    className="text-[#D81B7E] hover:underline"
                  >
                    privacy@rotagif.com
                  </a>
                  . Or contact the safeguarding leads directly (see Section 7).
                </p>
              </div>
            </div>
          </div>
