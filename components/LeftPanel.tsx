...
export default function LeftPanel() {
  ...
  return (
    <div
      className=" lg:flex flex-col lg:w-[47%] w-full mt-10 lg:mt-0 p-10 relative overflow-x-hidden [&::-webkit-scrollbar]:hidden"
      style={{
        background:
    ...
    >
      ...
      <div className="relative z-10 mt-5 shrink-0">
        <h3 className="text-white w-67.5">Your Journey Starts with the Right Pathway</h3>
      ...
      <div className="relative z-10 mt-10 space-y-3 pb-10">
        {programs.map((p) => (
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-full h-22 flex items-center pl-26.25 pr-4
            ...
            <div className="relative pt-22.5 px-6 pb-6
                            transition-all duration-500 ease-in-out
