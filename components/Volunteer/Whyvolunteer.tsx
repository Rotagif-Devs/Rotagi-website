...
<section className="py-20 px-6 text-center">
  <div className="max-w-5xl mx-auto">
    ...
    <p className="text-[#D62D88] font-medium mb-3">
      Why Volunteer with ROTAGI
    </p>
    <h2 className="text-2xl md:text-5xl font-cal-sans uppercase text-gray-950 mb-6">
      Your Time Can Change Her Future
    </h2>

    {/* Paragraphs */}
    <p className="text-[#373737] leading-relaxed mb-5">
    ...
    <p className="text-[#373737] leading-relaxed">
    ...
    <div className="mt-10 flex justify-center">
      <div className="bg-white px-10 py-4 rounded-[1rem] shadow-sm border border-pink-100">
        <span className="font-extrabold text-[#D62D88] text-2xl uppercase">
