...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      "img-src 'self' blob: data: https://paystack.com https://flagcdn.com https://i.pravatar.cc https://example.com https://rotagif-backend-codebase-1.onrender.com https://placehold.co https://res.cloudinary.com",
      "connect-src 'self' https://rotagif-backend-codebase-1.onrender.com https://checkout.paystack.com https://v6.exchangerate-api.com https://open.er-api.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
