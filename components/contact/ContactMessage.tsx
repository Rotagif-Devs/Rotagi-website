          ...
          >
            <div>
              ...
              <input
                ...
                className={`h-12 w-full rounded-xl bg-white px-4 text-sm text-slate-700 outline-none placeholder:text-[#c6bfd0] sm:h-16 sm:rounded-2xl sm:px-6 sm:text-base ${
                  errors.fullName
            ...
            <div>
              ...
              <input
                ...
                className={`h-14 w-full rounded-xl bg-white px-4 text-sm text-slate-700 outline-none placeholder:text-[#c6bfd0] sm:h-16 sm:rounded-2xl sm:px-6 sm:text-base ${
                  errors.email
                    ? "border border-red-500"
                    : "border border-[#f1e5ec] focus:border-[#e63b93]"
                }`}
