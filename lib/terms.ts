...
export const termsData: TermsSection[] = [
  ...
  {
    id: "programs",
    title: "Programs and Participation",
    content: [
      "ROTAGI offers various educational and empowerment programs designed for girls and women across different age groups.",
      "Participation in ROTAGI programs may require registration, eligibility verification, and adherence to program guidelines. ROTAGI reserves the right to review applications and determine participation eligibility based on program requirements.",
  ...
  {
    id: "changes",
    title: "Change to the Terms",
    content: [
      "ROTAGI reserves the right to update or modify these Terms and Conditions at any time to reflect changes in policies, services, or legal requirements.",
